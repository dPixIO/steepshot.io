...
urlpatterns = [
    ...
    url(r'^new/users/daily$', CountNewUsers.as_view(), name='new_users'),
    url(r'^new/users/monthly$', CountNewUsersMonthly.as_view(), name='new_users'),
    # url(r'^users/percent/daily$', CountPercentUsersDaily.as_view(), name='percent_users'),
